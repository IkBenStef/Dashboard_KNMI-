...
st.markdown("Dit is een DashBoard met data van KNMI api en de Open Meteo api. Dit dashboard is gemaakt door groep 1 voor de case: DashBoard")
...
hva_afbeelding = 'https://yt3.googleusercontent.com/CUsr6FlHXd8m0E9w_C65xVu902PDjqcbNIFliHJZlKM2gj-3YxwAyvGouyVo3eSxfqOUX90ajdE=s900-c-k-c0x00ffffff-no-rj'
