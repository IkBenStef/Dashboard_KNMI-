...
df_energie = df_energie[df_energie['Perioden'] > '1975']
df_energie = df_energie[df_energie['Perioden'].str.len() != 4]
df_energie['date'] = pd.to_datetime(df_energie['Perioden'], format='%Y %B', errors='coerce')
