...
with col2:
    ...
    st.error(f"{name_b}: {raw_data_b['hourly']['temperature_2m'][0]}°C")
...
fig_temp.add_trace(go.Scatter(x=df_locatieB["time"], y=df_locatieB["temp"], name=name_b, line=dict(color='#FF4B4B', width=3)))
...
fig_wind.add_trace(go.Scatter(x=df_locatieB["time"], y=df_locatieB["wind"], name=name_b, line=dict(color='#FF4B4B', dash='dot')))
...
fig_rain.add_trace(go.Bar(x=df_locatieB["time"], y=df_locatieB["rain"], name=name_b, marker_color='#FF4B4B', opacity=0.7))
